...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: '赵海鹏', // 必需
      link: 'https://github.com/qq9694526' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:9694526@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/qq9694526'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'ZHP | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
